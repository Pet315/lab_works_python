...
class Advance_Ticket(General):
    def __init__(self, unique_number, price, person_name, event_date):
        super().__init__(unique_number, price, person_name, event_date)
        self.price = self.price*constants.ADV_PRICE
...
class Student_Ticket(General):
    def __init__(self, unique_number, price, person_name, event_date):
        super().__init__(unique_number, price, person_name, event_date)
        self.price = self.price * constants.STUDENT_PRICE
...
class Late_Ticket(General):
    def __init__(self, unique_number, price, person_name, event_date):
        super().__init__(unique_number, price, person_name, event_date)
        self.price = self.price * constants.LAST_PRICE
...
def process(i=0):
    ...
    if ticket["is_student"]:
        obj = types[2]
    elif time_left > constants.ADV_LIMIT:
        obj = types[1]
    elif time_left < constants.LAST_LIMIT:
        obj = types[3]
    else:
        obj = types[0]
